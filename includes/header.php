...
<header class="header">
  ...
  <a href="../public/" aria-label="Ir a la página de inicio" >
    <img src="../assets/img/logo/logo2.png" alt="Logo de MoyaCreative" id="logo-header">
    <!-- <h2>MoyaCreative</h2>  -->
  </a>
  <div class="d-flex align-items-center gap-3">
  <button type="button" class="btn btn-black position-relative" onclick="window.location.href = '../public/carrito.php';">
